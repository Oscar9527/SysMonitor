...
public sealed class ThemeResourceApplier
{
    ...
    public bool Apply(ResolvedTheme theme)
    {
        ...
        var replacements = new Dictionary<string, object>
        {
            ...
            ["CpuMetricSoftBrush"] = isDefault ? CreateBrush("#EAF3FF") : CreateSoftBrush(metrics.Cpu),
            ["MemoryMetricSoftBrush"] = isDefault ? CreateBrush("#F5EAFB") : CreateSoftBrush(metrics.Memory),
            ["GpuMetricSoftBrush"] = isDefault ? CreateBrush("#EAF8EE") : CreateSoftBrush(metrics.Gpu),
            ["DetailPinBackgroundBrush"] = isDefault ? CreateBrush("#EAF3FF") : CreateSoftBrush(colors.Accent),
            ["DetailPinForegroundBrush"] = CreateBrush(colors.Accent),
            ["DetailUnpinnedForegroundBrush"] = CreateBrush(colors.Secondary),
            ["MetricTrackBrush"] = isDefault ? CreateBrush("#E9E9ED") : CreateBrush(colors.Separator),
