...
public partial class GameOverlayWindow : Window, IGameOverlayView
{
    ...
    public void SetAppearance(GameOverlayAppearance appearance)
    {
        ...
        SolidColorBrush gpuBrush = CreateBrush(_appearance.GpuColor, Colors.DarkOrange);
        SolidColorBrush cpuBrush = CreateBrush(_appearance.CpuColor, Colors.Cyan);
        SolidColorBrush fpsBrush = CreateBrush(_appearance.FpsColor, Colors.LimeGreen);
        SolidColorBrush memoryBrush = CreateBrush(_appearance.MemoryColor, Colors.Gold);
        SolidColorBrush networkBrush = CreateBrush(_appearance.NetworkColor, Colors.Magenta);
        SolidColorBrush valueBrush = CreateBrush(_appearance.ValueColor, Colors.White);
    ...
    public void UpdateMetrics(MonitorSnapshot monitor, GameOverlayFrameSnapshot frame, double? currentFrequencyMegahertz = null)
    {
        ...
        string fps = HasUsableFrameRate(frame) && frame.FramesPerSecond is double fpsValue
    ...
    internal static OverlayPixelRect CalculatePlacement(OverlayPixelRect workingArea, double widthDip, double heightDip, uint dpi, double marginDip = 2, double horizontalPositionPercent = 100)
    {
    ...
    private static double GetPresetMarginDip(uint dpi) => 2d;
